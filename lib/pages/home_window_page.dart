...
class HomeWindowPage extends StatefulWidget {
  const HomeWindowPage({super.key});

  @override
  State<HomeWindowPage> createState() => _HomeWindowPageState();
}

class _HomeWindowPageState extends State<HomeWindowPage> {
          ...
          IconButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const WeatherWindowPage(),
                ));
              },
              icon: const Icon(
